...
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
  ...
  getMenuItems(): MenuItem[] {
    return [
      ...
      new MenuItem(this.l('Register'), '', 'fas fa-user-plus', '', [
          new MenuItem(
                this.l('Users'),
                '/app/users',
                'fas fa-users',
        ...
        new MenuItem(this.l('Administration'), '', 'fas fa-toolbox', 'Pages.Administration', [
            new MenuItem(
                this.l('Maintenance'),
                '',
                'fas fa-tools',
                ...
                [
                    new MenuItem(
                        this.l('Departments'),
                        '/app/administration/maintenance/departments',
                        'fas fa-globe-americas',
                        'Pages.Administration'
                    ),
                    //new MenuItem(
                    //    this.l('Municipality'),
                    //    '/app/administration/maintenance/municipality',
                    //    'fas fa-globe-americas',
                    //    'Pages.Administration'
                    //)
                ]
      ...
      new MenuItem(this.l('Consultas'), '#', 'fas fa-search'),
      new MenuItem(
        this.l('Tenants'),
        '/app/tenants',
        'fas fa-building',
